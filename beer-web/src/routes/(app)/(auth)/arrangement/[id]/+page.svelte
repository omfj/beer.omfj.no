							...
							<div class="flex items-start justify-between gap-2">
								...
								{#if attendee.userId === user?.id}
									<button
										...
										disabled={deletingIds.has(attendee.id)}
										class="shrink-0 rounded p-1 text-red-600 transition-colors hover:bg-red-50 hover:text-red-700 disabled:cursor-wait disabled:opacity-50"
